...
- **Bots** — Discord bots and automation bots that run tasks for you
- **Web scraping** — turning websites into clean CSV or JSON
- **API integration** — pulling, processing and formatting data from any API
- **Backends and full-stack** — REST APIs and small web apps with a database
...
| [rss-watcher](https://github.com/pyflowlabs/rss-watcher) | Reports new feed entries to Discord | Python |

## Working together

Have a repetitive task or a tool in mind? I'm available for freelance work — tell me what you need
and I'll let you know exactly how I can help.
